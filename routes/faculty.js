...
const admin = require("../controllers/faculty/admin");
const faculty = require("../controllers/faculty/faculty");
const student = require("../controllers/faculty/student");
const courses = require("../controllers/faculty/courses");
const slots = require("../controllers/faculty/slots");
const batch = require("../controllers/faculty/batch");
